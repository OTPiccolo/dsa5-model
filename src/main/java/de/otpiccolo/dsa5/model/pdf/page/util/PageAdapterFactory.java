...
public class PageAdapterFactory extends AdapterFactoryImpl {
	...
	protected PageSwitch<Adapter> modelSwitch =
		new PageSwitch<Adapter>() {
			...
			@Override
			public Adapter casePredefinedPage(PredefinedPage object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.otpiccolo.dsa5.model.pdf.page.PredefinedPage <em>Predefined Page</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
