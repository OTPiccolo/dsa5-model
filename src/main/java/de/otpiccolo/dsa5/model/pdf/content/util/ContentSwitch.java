...
public class ContentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContentPackage.DATA_CONTENT: {
				DataContent dataContent = (DataContent)theEObject;
				T result = caseDataContent(dataContent);
				if (result == null) result = casePageContent(dataContent);
			...
			case ContentPackage.PARAGRAPH_CONTENT: {
				...
				if (result == null) result = casePageContent(paragraphContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentPackage.IMAGE_CONTENT: {
				...
				if (result == null) result = casePageContent(imageContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Content</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Content</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataContent(DataContent object) {
		return null;
	}
