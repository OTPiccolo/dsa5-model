 ...
 * </p>
 * <ul>
 *   <li>{@link de.otpiccolo.dsa5.model.pdf.content.impl.TableRowImpl#getTable <em>Table</em>}</li>
 *   <li>{@link de.otpiccolo.dsa5.model.pdf.content.impl.TableRowImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableRowImpl extends MinimalEObjectImpl.Container implements TableRow {
	...
	public TableContent getTable() {
		if (eContainerFeatureID() != ContentPackage.TABLE_ROW__TABLE) return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTable(TableContent newTable, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setTable(TableContent newTable) {
