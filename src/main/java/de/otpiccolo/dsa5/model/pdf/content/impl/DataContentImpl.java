 ...
 * </p>
 * <ul>
 * <li>{@link de.otpiccolo.dsa5.model.pdf.content.impl.DataContentImpl#getContent
 * <em>Content</em>}</li>
 * <li>{@link de.otpiccolo.dsa5.model.pdf.content.impl.DataContentImpl#getContentType
 * <em>Content Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataContentImpl extends MinimalEObjectImpl.Container implements DataContent {
	...
	/**
	 * The default value of the '{@link #getContentType() <em>Content
	 ...
	 * @ordered
	 */
	protected static final ContentType CONTENT_TYPE_EDEFAULT = ContentType.ALLGEMEINE_SONDERFERTIGKEIT;
	...
	public void setContentType(final ContentType newContentType) {
		final ContentType oldContentType = contentType;
		contentType = newContentType == null ? CONTENT_TYPE_EDEFAULT : newContentType;
		final boolean oldContentTypeESet = contentTypeESet;
